      ...
      <View style={{ paddingVertical: IOVisualCostants.appMarginDefault }}>
        ...
        >
          <IOButton
            ...
            fullWidth
            label="Bottom"
            onPress={() => setIsBottomVisible(true)}
          />
        </Tooltip>
        <VSpacer />
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          >
            <IOButton
              ...
              fullWidth
              label="Right"
              onPress={() => setIsRightVisible(true)}
            />
          </Tooltip>
          <Tooltip
            placement="left"
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          >
            <IOButton
              ...
              fullWidth
              label="Top"
              onPress={() => setIsTopLefttVisible(true)}
            />
          </Tooltip>
          <Tooltip
            placement="bottom"
          ...
          >
            <IOButton
              ...
              fullWidth
              label="Bottom"
              onPress={() => setIsBottomRighttVisible(true)}
            />
          </Tooltip>
        </View>
      </View>
