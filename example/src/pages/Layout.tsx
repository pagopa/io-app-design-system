import { Body, ContentWrapper, Divider, H1, H3, HSpacer, IOAppMargin, IOColors, IOSpacer, IOThemeContext, LabelSmall, VDivider, VSpacer } from "@pagopa/io-app-design-system";
