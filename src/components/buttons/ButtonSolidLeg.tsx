/**
 * TODO: This is actually a temporary file, optimized code merging with ButtonSolid.tsx is needed
 */
 ...
 *
 */
export const ButtonSolidLegacy = ({
  color = "primary",
  label,
  small = false,
  fullWidth = false,
...
export default ButtonSolidLegacy;
