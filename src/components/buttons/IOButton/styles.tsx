...
export const useButtonColorMap = (variant: IOButtonVariant) => {
  ...
  const transparentLinkBackground: ColorStates["background"] = useMemo(
    () => ({
      default: "transparent",
      pressed: "transparent",
      disabled: "transparent"
  ...
  > = useMemo(
    ...
    [theme, transparentLinkBackground]
  );
  ...
  const colorMap = useMemo(
    ...
    [
      mapColorStatesVariantLink,
      mapColorStatesVariantOutline,
      mapColorStatesVariantSolid
    ]
  );

  return useMemo(() => colorMap[variant], [colorMap, variant]);
};
