...
import { ActivityIndicator, Button, Text as NBButtonText, StyleSheet, View } from "react-native";
...
export type BlockButtonProps = React.ComponentProps<typeof Button> & OwnButtonProps;
...
export default class BlockButtons extends React.Component<Props, never> {
    ...
    private renderButton = (
        ...
        style: React.ComponentProps<typeof ButtonDefaultOpacity>["style"]
    ) => (
